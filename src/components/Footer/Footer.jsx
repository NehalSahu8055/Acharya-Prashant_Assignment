...
export default function Footer({ setMyRef }) {
  return (
    <footer className="grid min-h-screen flex-wrap place-content-center whitespace-break-spaces break-words bg-slate-900 p-2 pt-10 text-sm">
      <div className="text-md flex w-full flex-col space-y-5 px-8 pt-8 md:flex-row md:justify-center md:space-x-2 md:space-y-0 md:pt-0 lg:space-x-10">
        <div>
          ...
          <ul className="flex flex-col">
            <li className="mb-2.5">
              <a
                ...
                className="hover:text-brand-700 text-slate-300 hover:cursor-pointer"
              >
            ...
            <li className="mb-2.5">
              <a
                href="/en/vedant-samhita"
                className="hover:text-brand-700 text-slate-300 hover:cursor-pointer"
              >
                <span className="font-en">Vedant Samhita</span>
              </a>
            </li>
            <li className="mb-2.5">
              <a
        ...
        <div>
          ...
          <div className="mb-6 flex flex-col ">
            ...
            <div className="flex space-x-2">
              <div className="hover:text-brand-700 text-slate-300">
                <a
        ...
        <div>
          <div className="mb-[13px] pt-2 font-semibold text-slate-100">
            <span className="font-en md:hidden">
              DOWNLOAD ACHARYA PRASHANT APP
            </span>
            <span className="font-en hidden md:block">DOWNLOAD APP</span>
          </div>
          ...
          <ul className="flex md:flex-col">
            <li className="mr-4 h-8 w-28 md:mb-5 md:mr-0 md:w-[114px]">
              <a
                target="_blank"
            ...
            <li className="h-8 w-28 md:w-[114px]">
              <a
                target="_blank"
        ...
        <div className="space-y-3 pt-2 md:pt-0">
          ...
          <ul className="mb-2.5 flex items-center">
            <li className="pr-2 text-slate-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="16"
            ...
            <li>
              <a
                ...
                className="hover:text-brand-700 text-slate-300"
              >
          ...
          <ul className="mb-[13px] flex items-center">
            <li className="pr-2 text-slate-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          <ul className="mb-5 flex items-center">
            ...
            <li>
              <a
                ...
                className="hover:text-brand-700 flex text-slate-300"
              >
                <span className="font-en">+91 9650585100</span>
              </a>
            </li>
          ...
          <ul className="mb-5 flex items-start">
            <li className="pr-3 pt-1 text-slate-300 lg:pt-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="15"
                height="18"
      ...
      <div className="flex-col flex-wrap px-4 pb-[6rem] text-xs md:mx-auto md:flex md:flex-row md:justify-center md:text-sm">
        <div className="text-slate-300 md:pr-20">
          <span className="font-en">
            Copyright © 2023 PrashantAdvait Foundation
          </span>
        </div>
        <div className="flex space-x-2 pt-2 md:pt-0">
          <a
            href="/en/terms-and-conditions"
            className="hover:text-brand-700 cursor-pointer text-slate-300"
          >
          ...
          <a
            ...
            className="hover:text-brand-700 cursor-pointer text-slate-300"
          >
            <span className="font-en">Undertaking</span>
          </a>
        </div>
      </div>
      ...
      <div className="open-app">
        <div className="bg-brand-100 fixed bottom-0 left-0 right-0 z-[370] w-full px-4 py-[0.625rem] lg:hidden">
          <div className="flex items-center justify-between">
            ...
            <Button
              type="solid"
              label="Download App"
              classes="rounded-2xl px-3 py-1.5 text-xs md:text-base "
              image="/images/ic_download.svg"
            />
          </div>
        </div>
      </div>
